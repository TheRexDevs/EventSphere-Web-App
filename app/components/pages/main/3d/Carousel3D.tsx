...
import firstimg from "@/public/3dimg/firstimg.jpg";
import secondimg from "@/public/3dimg/secondimg.jpg";
import thirdimg from "@/public/3dimg/thirdimg.jpg";
import fourthimg from "@/public/3dimg/fouthimg.jpg";

const images = [firstimg, secondimg, thirdimg, fourthimg];

export default function Carousel3DC({ initial = 0 }: { initial?: number }) {
